 ...
 */
suspend fun SynthesizeSpeechRequest.presign(presignConfig: ServicePresignConfig, duration: Duration): HttpRequest {
 ...
 * @return The [HttpRequest] that can be invoked within the specified time window.
 */
suspend fun SynthesizeSpeechRequest.presign(config: PollyClient.Config, duration: Duration): HttpRequest {
