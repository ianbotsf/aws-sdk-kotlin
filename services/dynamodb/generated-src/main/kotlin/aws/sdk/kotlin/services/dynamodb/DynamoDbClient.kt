...
interface DynamoDbClient : SdkClient {
    ...
    companion object {
        operator fun invoke(block: Config.Builder.() -> Unit): DynamoDbClient {
         ...
         */
        suspend fun fromEnvironment(block: (Config.Builder.() -> Unit)? = null): DynamoDbClient {
     ...
     * DynamoDB's JSON format for the API call. For more details on this distinction, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.NamingRulesDataTypes.html">Naming Rules and Data Types.
     *
     *
