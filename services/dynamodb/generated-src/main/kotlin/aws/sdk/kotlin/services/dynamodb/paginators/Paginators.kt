 ...
 * @return A [kotlinx.coroutines.flow.Flow] that can collect [QueryResponse]
 */
fun DynamoDbClient.queryPaginated(block: QueryRequest.Builder.() -> Unit): Flow<QueryResponse> =
 ...
 * @return A [kotlinx.coroutines.flow.Flow] that can collect [ScanResponse]
 */
fun DynamoDbClient.scanPaginated(block: ScanRequest.Builder.() -> Unit): Flow<ScanResponse> =
