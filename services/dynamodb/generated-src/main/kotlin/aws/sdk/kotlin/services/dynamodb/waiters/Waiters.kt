...
suspend fun DynamoDbClient.waitUntilTableExists(request: DescribeTableRequest): Outcome<DescribeTableResponse> {
    val strategy = run {
...
suspend fun DynamoDbClient.waitUntilTableNotExists(request: DescribeTableRequest): Outcome<DescribeTableResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 20_000.milliseconds,
            scaleFactor = 1.5,
