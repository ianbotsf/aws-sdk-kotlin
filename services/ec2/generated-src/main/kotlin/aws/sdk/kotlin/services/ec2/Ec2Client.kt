...
interface Ec2Client : SdkClient {
    ...
    companion object {
        operator fun invoke(block: Config.Builder.() -> Unit): Ec2Client {
         ...
         */
        suspend fun fromEnvironment(block: (Config.Builder.() -> Unit)? = null): Ec2Client {
     ...
     * For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet.html">EC2 Fleet in the Amazon EC2 User Guide.
     */
     ...
     *
     *
     * For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/manage-ec2-fleet.html#delete-fleet">Delete an EC2
     ...
     * For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/manage-ec2-fleet.html#monitor-ec2-fleet">Monitor your EC2 Fleet in the Amazon EC2 User Guide.
     */
     ...
     * Bin in the Amazon Elastic Compute Cloud User Guide.
     */
    suspend fun listImagesInRecycleBin(input: ListImagesInRecycleBinRequest): ListImagesInRecycleBinResponse
     ...
     * Bin in the Amazon Elastic Compute Cloud User Guide.
     */
    suspend fun listImagesInRecycleBin(block: ListImagesInRecycleBinRequest.Builder.() -> Unit) = listImagesInRecycleBin(ListImagesInRecycleBinRequest.Builder().apply(block).build())
     ...
     * To disable detailed monitoring, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_UnmonitorInstances.html">UnmonitorInstances.
     */
     ...
     *
     * To remove tags, use <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DeregisterInstanceEventNotificationAttributes.html">DeregisterInstanceEventNotificationAttributes.
     */
    ...
    /**
     * Restores an AMI from the Recycle Bin. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/recycle-bin.html">Recycle Bin in the Amazon Elastic Compute Cloud User Guide.
     */
    suspend fun restoreImageFromRecycleBin(input: RestoreImageFromRecycleBinRequest): RestoreImageFromRecycleBinResponse

    /**
     * Restores an AMI from the Recycle Bin. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/recycle-bin.html">Recycle Bin in the Amazon Elastic Compute Cloud User Guide.
     */
    suspend fun restoreImageFromRecycleBin(block: RestoreImageFromRecycleBinRequest.Builder.() -> Unit) = restoreImageFromRecycleBin(RestoreImageFromRecycleBinRequest.Builder().apply(block).build())
