...
suspend fun Ec2Client.waitUntilBundleTaskComplete(request: DescribeBundleTasksRequest): Outcome<DescribeBundleTasksResponse> {
    val strategy = run {
    ...
    val acceptors = listOf<Acceptor<DescribeBundleTasksRequest, DescribeBundleTasksResponse>>(
        OutputAcceptor(RetryDirective.TerminateAndSucceed) {
            ...
            (projection?.size ?: 0) > 1 && projection?.all { it?.toString() == "complete" }
        },
...
suspend fun Ec2Client.waitUntilBundleTaskComplete(block: DescribeBundleTasksRequest.Builder.() -> Unit): Outcome<DescribeBundleTasksResponse> =
    waitUntilBundleTaskComplete(DescribeBundleTasksRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilConversionTaskCancelled(request: DescribeConversionTasksRequest): Outcome<DescribeConversionTasksResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
    ...
    val acceptors = listOf<Acceptor<DescribeConversionTasksRequest, DescribeConversionTasksResponse>>(
        OutputAcceptor(RetryDirective.TerminateAndSucceed) {
            ...
            (projection?.size ?: 0) > 1 && projection?.all { it?.toString() == "cancelled" }
        },
    )
...
suspend fun Ec2Client.waitUntilConversionTaskCancelled(block: DescribeConversionTasksRequest.Builder.() -> Unit): Outcome<DescribeConversionTasksResponse> =
    waitUntilConversionTaskCancelled(DescribeConversionTasksRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilConversionTaskCompleted(request: DescribeConversionTasksRequest): Outcome<DescribeConversionTasksResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilConversionTaskCompleted(block: DescribeConversionTasksRequest.Builder.() -> Unit): Outcome<DescribeConversionTasksResponse> =
    waitUntilConversionTaskCompleted(DescribeConversionTasksRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilConversionTaskDeleted(request: DescribeConversionTasksRequest): Outcome<DescribeConversionTasksResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
    ...
    val acceptors = listOf<Acceptor<DescribeConversionTasksRequest, DescribeConversionTasksResponse>>(
        OutputAcceptor(RetryDirective.TerminateAndSucceed) {
            ...
            (projection?.size ?: 0) > 1 && projection?.all { it?.toString() == "deleted" }
        },
    )
...
suspend fun Ec2Client.waitUntilConversionTaskDeleted(block: DescribeConversionTasksRequest.Builder.() -> Unit): Outcome<DescribeConversionTasksResponse> =
    waitUntilConversionTaskDeleted(DescribeConversionTasksRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilCustomerGatewayAvailable(request: DescribeCustomerGatewaysRequest): Outcome<DescribeCustomerGatewaysResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilCustomerGatewayAvailable(block: DescribeCustomerGatewaysRequest.Builder.() -> Unit): Outcome<DescribeCustomerGatewaysResponse> =
    waitUntilCustomerGatewayAvailable(DescribeCustomerGatewaysRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilExportTaskCancelled(request: DescribeExportTasksRequest): Outcome<DescribeExportTasksResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilExportTaskCancelled(block: DescribeExportTasksRequest.Builder.() -> Unit): Outcome<DescribeExportTasksResponse> =
    waitUntilExportTaskCancelled(DescribeExportTasksRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilExportTaskCompleted(request: DescribeExportTasksRequest): Outcome<DescribeExportTasksResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilExportTaskCompleted(block: DescribeExportTasksRequest.Builder.() -> Unit): Outcome<DescribeExportTasksResponse> =
    waitUntilExportTaskCompleted(DescribeExportTasksRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilImageAvailable(request: DescribeImagesRequest): Outcome<DescribeImagesResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilImageAvailable(block: DescribeImagesRequest.Builder.() -> Unit): Outcome<DescribeImagesResponse> =
    waitUntilImageAvailable(DescribeImagesRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilImageExists(request: DescribeImagesRequest): Outcome<DescribeImagesResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilImageExists(block: DescribeImagesRequest.Builder.() -> Unit): Outcome<DescribeImagesResponse> =
    waitUntilImageExists(DescribeImagesRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilInstanceExists(request: DescribeInstancesRequest): Outcome<DescribeInstancesResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
...
suspend fun Ec2Client.waitUntilInstanceExists(block: DescribeInstancesRequest.Builder.() -> Unit): Outcome<DescribeInstancesResponse> =
    waitUntilInstanceExists(DescribeInstancesRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilInstanceRunning(request: DescribeInstancesRequest): Outcome<DescribeInstancesResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
    ...
    val acceptors = listOf<Acceptor<DescribeInstancesRequest, DescribeInstancesResponse>>(
        OutputAcceptor(RetryDirective.TerminateAndSucceed) {
            ...
            (projection2?.size ?: 0) > 1 && projection2?.all { it?.toString() == "running" }
        },
        OutputAcceptor(RetryDirective.TerminateAndFail) {
            val reservations = it?.reservations
            val reservationsOrEmpty = reservations?.flattenIfPossible() ?: listOf()
...
suspend fun Ec2Client.waitUntilInstanceRunning(block: DescribeInstancesRequest.Builder.() -> Unit): Outcome<DescribeInstancesResponse> =
    waitUntilInstanceRunning(DescribeInstancesRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilInstanceStopped(request: DescribeInstancesRequest): Outcome<DescribeInstancesResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
    ...
    val acceptors = listOf<Acceptor<DescribeInstancesRequest, DescribeInstancesResponse>>(
        OutputAcceptor(RetryDirective.TerminateAndSucceed) {
            ...
            (projection2?.size ?: 0) > 1 && projection2?.all { it?.toString() == "stopped" }
        },
        OutputAcceptor(RetryDirective.TerminateAndFail) {
            val reservations = it?.reservations
            val reservationsOrEmpty = reservations?.flattenIfPossible() ?: listOf()
...
suspend fun Ec2Client.waitUntilInstanceStopped(block: DescribeInstancesRequest.Builder.() -> Unit): Outcome<DescribeInstancesResponse> =
    waitUntilInstanceStopped(DescribeInstancesRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilInstanceTerminated(request: DescribeInstancesRequest): Outcome<DescribeInstancesResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
    ...
    val acceptors = listOf<Acceptor<DescribeInstancesRequest, DescribeInstancesResponse>>(
        OutputAcceptor(RetryDirective.TerminateAndSucceed) {
            ...
            (projection2?.size ?: 0) > 1 && projection2?.all { it?.toString() == "terminated" }
        },
        OutputAcceptor(RetryDirective.TerminateAndFail) {
            val reservations = it?.reservations
            val reservationsOrEmpty = reservations?.flattenIfPossible() ?: listOf()
...
suspend fun Ec2Client.waitUntilInstanceTerminated(block: DescribeInstancesRequest.Builder.() -> Unit): Outcome<DescribeInstancesResponse> =
    waitUntilInstanceTerminated(DescribeInstancesRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilInstanceStatusOk(request: DescribeInstanceStatusRequest): Outcome<DescribeInstanceStatusResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
    ...
    val acceptors = listOf<Acceptor<DescribeInstanceStatusRequest, DescribeInstanceStatusResponse>>(
        OutputAcceptor(RetryDirective.TerminateAndSucceed) {
            ...
            (projection?.size ?: 0) > 1 && projection?.all { it?.toString() == "ok" }
        },
        ErrorTypeAcceptor(RetryDirective.RetryError(RetryErrorType.ServerSide), "InvalidInstanceID.NotFound"),
    )
...
suspend fun Ec2Client.waitUntilInstanceStatusOk(block: DescribeInstanceStatusRequest.Builder.() -> Unit): Outcome<DescribeInstanceStatusResponse> =
    waitUntilInstanceStatusOk(DescribeInstanceStatusRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilSystemStatusOk(request: DescribeInstanceStatusRequest): Outcome<DescribeInstanceStatusResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilSystemStatusOk(block: DescribeInstanceStatusRequest.Builder.() -> Unit): Outcome<DescribeInstanceStatusResponse> =
    waitUntilSystemStatusOk(DescribeInstanceStatusRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilInternetGatewayExists(request: DescribeInternetGatewaysRequest): Outcome<DescribeInternetGatewaysResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 5_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilInternetGatewayExists(block: DescribeInternetGatewaysRequest.Builder.() -> Unit): Outcome<DescribeInternetGatewaysResponse> =
    waitUntilInternetGatewayExists(DescribeInternetGatewaysRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilKeyPairExists(request: DescribeKeyPairsRequest): Outcome<DescribeKeyPairsResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 5_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilKeyPairExists(block: DescribeKeyPairsRequest.Builder.() -> Unit): Outcome<DescribeKeyPairsResponse> =
    waitUntilKeyPairExists(DescribeKeyPairsRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilNatGatewayAvailable(request: DescribeNatGatewaysRequest): Outcome<DescribeNatGatewaysResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilNatGatewayAvailable(block: DescribeNatGatewaysRequest.Builder.() -> Unit): Outcome<DescribeNatGatewaysResponse> =
    waitUntilNatGatewayAvailable(DescribeNatGatewaysRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilNetworkInterfaceAvailable(request: DescribeNetworkInterfacesRequest): Outcome<DescribeNetworkInterfacesResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
...
suspend fun Ec2Client.waitUntilNetworkInterfaceAvailable(block: DescribeNetworkInterfacesRequest.Builder.() -> Unit): Outcome<DescribeNetworkInterfacesResponse> =
    waitUntilNetworkInterfaceAvailable(DescribeNetworkInterfacesRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilSecurityGroupExists(request: DescribeSecurityGroupsRequest): Outcome<DescribeSecurityGroupsResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 5_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilSecurityGroupExists(block: DescribeSecurityGroupsRequest.Builder.() -> Unit): Outcome<DescribeSecurityGroupsResponse> =
    waitUntilSecurityGroupExists(DescribeSecurityGroupsRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilSnapshotCompleted(request: DescribeSnapshotsRequest): Outcome<DescribeSnapshotsResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilSpotInstanceRequestFulfilled(request: DescribeSpotInstanceRequestsRequest): Outcome<DescribeSpotInstanceRequestsResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
    ...
    val acceptors = listOf<Acceptor<DescribeSpotInstanceRequestsRequest, DescribeSpotInstanceRequestsResponse>>(
        OutputAcceptor(RetryDirective.TerminateAndSucceed) {
            ...
            (projection?.size ?: 0) > 1 && projection?.all { it?.toString() == "fulfilled" }
        },
        OutputAcceptor(RetryDirective.TerminateAndSucceed) {
            val spotInstanceRequests = it?.spotInstanceRequests
            val spotInstanceRequestsOrEmpty = spotInstanceRequests?.flattenIfPossible() ?: listOf()
            ...
            (projection?.size ?: 0) > 1 && projection?.all { it?.toString() == "request-canceled-and-instance-running" }
        },
        OutputAcceptor(RetryDirective.TerminateAndFail) {
            val spotInstanceRequests = it?.spotInstanceRequests
            val spotInstanceRequestsOrEmpty = spotInstanceRequests?.flattenIfPossible() ?: listOf()
...
suspend fun Ec2Client.waitUntilSpotInstanceRequestFulfilled(block: DescribeSpotInstanceRequestsRequest.Builder.() -> Unit): Outcome<DescribeSpotInstanceRequestsResponse> =
    waitUntilSpotInstanceRequestFulfilled(DescribeSpotInstanceRequestsRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilSubnetAvailable(request: DescribeSubnetsRequest): Outcome<DescribeSubnetsResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilSubnetAvailable(block: DescribeSubnetsRequest.Builder.() -> Unit): Outcome<DescribeSubnetsResponse> =
    waitUntilSubnetAvailable(DescribeSubnetsRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilVolumeAvailable(request: DescribeVolumesRequest): Outcome<DescribeVolumesResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilVolumeAvailable(block: DescribeVolumesRequest.Builder.() -> Unit): Outcome<DescribeVolumesResponse> =
    waitUntilVolumeAvailable(DescribeVolumesRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilVolumeDeleted(request: DescribeVolumesRequest): Outcome<DescribeVolumesResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilVolumeDeleted(block: DescribeVolumesRequest.Builder.() -> Unit): Outcome<DescribeVolumesResponse> =
    waitUntilVolumeDeleted(DescribeVolumesRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilVolumeInUse(request: DescribeVolumesRequest): Outcome<DescribeVolumesResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
    ...
    val acceptors = listOf<Acceptor<DescribeVolumesRequest, DescribeVolumesResponse>>(
        OutputAcceptor(RetryDirective.TerminateAndSucceed) {
            ...
            (projection?.size ?: 0) > 1 && projection?.all { it?.toString() == "in-use" }
        },
        OutputAcceptor(RetryDirective.TerminateAndFail) {
            val volumes = it?.volumes
            val volumesOrEmpty = volumes?.flattenIfPossible() ?: listOf()
...
suspend fun Ec2Client.waitUntilVolumeInUse(block: DescribeVolumesRequest.Builder.() -> Unit): Outcome<DescribeVolumesResponse> =
    waitUntilVolumeInUse(DescribeVolumesRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilVpcPeeringConnectionDeleted(request: DescribeVpcPeeringConnectionsRequest): Outcome<DescribeVpcPeeringConnectionsResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilVpcPeeringConnectionDeleted(block: DescribeVpcPeeringConnectionsRequest.Builder.() -> Unit): Outcome<DescribeVpcPeeringConnectionsResponse> =
    waitUntilVpcPeeringConnectionDeleted(DescribeVpcPeeringConnectionsRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilVpcPeeringConnectionExists(request: DescribeVpcPeeringConnectionsRequest): Outcome<DescribeVpcPeeringConnectionsResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilVpcPeeringConnectionExists(block: DescribeVpcPeeringConnectionsRequest.Builder.() -> Unit): Outcome<DescribeVpcPeeringConnectionsResponse> =
    waitUntilVpcPeeringConnectionExists(DescribeVpcPeeringConnectionsRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilVpcAvailable(request: DescribeVpcsRequest): Outcome<DescribeVpcsResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilVpcAvailable(block: DescribeVpcsRequest.Builder.() -> Unit): Outcome<DescribeVpcsResponse> =
    waitUntilVpcAvailable(DescribeVpcsRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilVpcExists(request: DescribeVpcsRequest): Outcome<DescribeVpcsResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
...
suspend fun Ec2Client.waitUntilVpcExists(block: DescribeVpcsRequest.Builder.() -> Unit): Outcome<DescribeVpcsResponse> =
    waitUntilVpcExists(DescribeVpcsRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilVpnConnectionAvailable(request: DescribeVpnConnectionsRequest): Outcome<DescribeVpnConnectionsResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilVpnConnectionAvailable(block: DescribeVpnConnectionsRequest.Builder.() -> Unit): Outcome<DescribeVpnConnectionsResponse> =
    waitUntilVpnConnectionAvailable(DescribeVpnConnectionsRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilVpnConnectionDeleted(request: DescribeVpnConnectionsRequest): Outcome<DescribeVpnConnectionsResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilVpnConnectionDeleted(block: DescribeVpnConnectionsRequest.Builder.() -> Unit): Outcome<DescribeVpnConnectionsResponse> =
    waitUntilVpnConnectionDeleted(DescribeVpnConnectionsRequest.Builder().apply(block).build())

suspend fun Ec2Client.waitUntilPasswordDataAvailable(request: GetPasswordDataRequest): Outcome<GetPasswordDataResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilPasswordDataAvailable(block: GetPasswordDataRequest.Builder.() -> Unit): Outcome<GetPasswordDataResponse> =
