...
suspend fun S3Client.waitUntilBucketExists(request: HeadBucketRequest): Outcome<HeadBucketResponse> {
    val strategy = run {
...
suspend fun S3Client.waitUntilBucketExists(block: HeadBucketRequest.Builder.() -> Unit): Outcome<HeadBucketResponse> =
    waitUntilBucketExists(HeadBucketRequest.Builder().apply(block).build())

suspend fun S3Client.waitUntilBucketNotExists(request: HeadBucketRequest): Outcome<HeadBucketResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 5_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun S3Client.waitUntilBucketNotExists(block: HeadBucketRequest.Builder.() -> Unit): Outcome<HeadBucketResponse> =
    waitUntilBucketNotExists(HeadBucketRequest.Builder().apply(block).build())

suspend fun S3Client.waitUntilObjectExists(request: HeadObjectRequest): Outcome<HeadObjectResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 5_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun S3Client.waitUntilObjectExists(block: HeadObjectRequest.Builder.() -> Unit): Outcome<HeadObjectResponse> =
    waitUntilObjectExists(HeadObjectRequest.Builder().apply(block).build())

suspend fun S3Client.waitUntilObjectNotExists(request: HeadObjectRequest): Outcome<HeadObjectResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 5_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun S3Client.waitUntilObjectNotExists(block: HeadObjectRequest.Builder.() -> Unit): Outcome<HeadObjectResponse> =
